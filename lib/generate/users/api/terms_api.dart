...
import 'package:mypoly/generate/users/model/terms_list_response.dart';
...
abstract class TermsApi {
  ...
  ///
  @GET('/terms')
  Future<TermsListResponse> getLatestTerms({CancelToken? cancelToken});
  ...
  ///
  @GET('/terms/{termsId}')
  Future<TermsResponse> getTermsMeta({
    @Path('termsId') required int termsId,
    CancelToken? cancelToken,
  });
}
