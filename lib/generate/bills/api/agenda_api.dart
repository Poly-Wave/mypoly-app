...
abstract class AgendaApi {
  ...
  /// 관심 주제 안건 목록 조회
  /// 관심 주제 기반 안건 목록을 반환합니다. 로그인한 사용자만 호출 가능합니다. - sortType&#x3D;LATEST: 최신 등록일 기준 내림차순 (기본값) - sortType&#x3D;POPULAR: 최근 7일 투표 완료 수(배치 스냅샷) 기준 내림차순 - 사용자 관심 주제와 일치하는 카테고리만 필터링됩니다. - 본 API는 조회수/투표수를 반환하지 않습니다. - 각 항목은 AI 헤드라인(&#x60;headline&#x60;)과 요약 본문(&#x60;content&#x60;)을 포함합니다.
  ///
  /// Parameters:
  ...
  /// 안건 메인 목록 조회
  /// 안건 메인 화면용 목록을 반환합니다. 로그인한 사용자만 호출 가능합니다. - sortType&#x3D;LATEST: 최신 등록일 기준 내림차순 (기본값) - sortType&#x3D;POPULAR: 최근 7일 투표 완료 수(배치 스냅샷) 기준 내림차순 - categoryCodes 미지정 시: 사용자 관심 주제와 일치하는 카테고리만 상시 필터링됩니다. - categoryCodes 지정 시: 전달된 주제 코드 목록으로 필터링합니다. - 각 항목은 AI 헤드라인(&#x60;headline&#x60;)과 요약 본문(&#x60;content&#x60;)을 포함합니다.
  ///
  /// Parameters:
  ...
  /// 인기 안건 조회
  /// KST 월요일 00:00 기준 이번 주 조회 증가분 Top 5를 반환합니다. 로그인한 사용자만 호출 가능합니다. - TRENDING 탭(7일 투표 수)과 달리 **조회수** 기준이며, **주간(월~일)** 구간입니다. - 약 10분 주기 배치로 선계산된 &#x60;bill_popular_view_ranking&#x60; 스냅샷을 조회합니다. - 카테고리 필터 없이 전체 의안 대상입니다. - &#x60;previousRank&#x60;: 직전 배치 실행 시점의 순위 (없으면 null) - &#x60;rankChangeSteps&#x60;: 직전 배치 대비 순위 변동 단계 수 (상승&#x3D;양수, 하락&#x3D;음수, 유지/신규&#x3D;0) - &#x60;rankChangeType&#x60;: 순위 변동 유형 (UP, DOWN, SAME, NEW) - 각 항목은 AI 헤드라인(&#x60;headline&#x60;)을 포함합니다.
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ///
  ...
  /// 의안 제목 검색
  /// 입력한 키워드가 의안 제목에 포함된 안건 목록을 반환합니다. 최신 등록일(proposalDate) 기준 내림차순으로 정렬됩니다. 각 항목은 AI 헤드라인(&#x60;headline&#x60;)을 포함합니다.
  ///
  /// Parameters:
  /// * [keyword] - 검색 키워드
  /// * [page] - 페이지 번호, 0부터 시작
