...
abstract class VoteApi {
  ...
  /// 참여한 투표 안건 목록 조회
  /// 로그인 사용자가 참여한 투표 안건 목록을 조회합니다.  - 날짜 필터는 &#39;투표한 날짜&#39; 기준입니다. - voteResults는 현재 사용자의 투표 결과 기준입니다. 사용 가능 값: AGREE, DISAGREE - sortType 기본값은 LATEST입니다. - 정렬은 sortType으로만 제어합니다. - 사용 가능 값: LATEST, POPULAR
  ///
  /// Parameters:
